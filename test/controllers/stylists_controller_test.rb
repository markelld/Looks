...
class StylistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stylist" do
    assert_difference("Stylist.count") do
      post stylists_url, params: { stylist: { bio: @stylist.bio, instagram: @stylist.instagram, name: @stylist.name, rate: @stylist.rate, user_id: @stylist.user_id } }
    end
  ...
  test "should update stylist" do
    patch stylist_url(@stylist), params: { stylist: { bio: @stylist.bio, instagram: @stylist.instagram, name: @stylist.name, rate: @stylist.rate, user_id: @stylist.user_id } }
